...
func (g *Game) DrawBoxScreen(left, top, right, bottom int, color Color, isSolid bool) {
...
func (g *Game) DrawBoxMap(left, top, right, bottom int, color Color, isSolid bool) {
...
func (g *Game) DrawCircleScreen(x, y, radius int, color Color, isSolid bool) {
...
func (g *Game) DrawCircleMap(x, y, radius int, color Color, isSolid bool) {
...
func (g *Game) DrawLineScreen(x1, y1, x2, y2 int, color Color) {
...
func (g *Game) DrawLineMap(x1, y1, x2, y2 int, color Color) {
...
func (g *Game) DrawDotScreen(x, y int, color Color) {
...
func (g *Game) DrawDotMap(x, y int, color Color) {
